...
if (store_pay_ready()) {
	...
	if ($url !== '') {
		$body .= '<p><a class="ke-btn" href="' . store_h($url) . '">Continue to GCash / card</a></p>';
	} else {
		$body .= '<p class="ke-err">PayMongo did not return a checkout link. Use GCash below or Book now instead.</p>';
	}
} else {
